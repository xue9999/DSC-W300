...
The SHA1 compression round function was not newly audited in full, no firmware hash routine was emulated, and no real camera challenge was collected. The result therefore establishes matching bytes, keys and protocol structure. It does not establish a completed G3 or W300 authentication session or equivalent behavior for every possible input.
